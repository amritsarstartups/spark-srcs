"use client"
import { Book, BookCopy, firebaseBookCopyOperations, firebaseBookOperations, firebaseTransactionOperations, firebaseUserOperations } from 'apps/sfl-next/src/utils/utils';
...
function BorrowBookUser({ params }: { params: Params }) {
  ...
  const resolvedParams = React.use(params) as Params;
